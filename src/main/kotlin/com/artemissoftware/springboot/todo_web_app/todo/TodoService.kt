...
class TodoService {
    ...
    fun findByUsername(username: String) = TODOS.filter { it.username == username }
    ...
    private companion object {
        var TODOS = mutableListOf(
            ...
            Todo(4, "test", "Bronze Saint", LocalDate.now().plusYears(3), false),
            Todo(5, "test", "Bronze Saint", LocalDate.now().plusYears(3), false)
        )
    }
}
